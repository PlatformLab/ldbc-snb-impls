...
/**
 * Encapsulates the state of a connection to a set of TorcDbServers.
 *
 * Notes:
 ...
 * connections to each of the TorcDbServers.
 *
 * @author Jonathan Ellithorpe (jde@cs.stanford.edu)
 */
public class TorcDbClientConnectionState extends DbConnectionState {

  // IPs of the TorcDbServers
