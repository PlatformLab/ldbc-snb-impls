...
import net.ellitron.ldbcsnbimpls.interactive.torcdb2.TorcDb2Server.*;
 ...
 * across multiple TorcDb2Servers. 
 *
 * @author Jonathan Ellithorpe (jde@cs.stanford.edu)
 */
public class TorcDb2Client extends Db {

  // Holds the state of our connections to TorcDb2Servers
  private TorcDb2ClientConnectionState connectionState = null;

  @Override
  protected void onInit(Map<String, String> properties,
      LoggingService loggingService) throws DbException {

    connectionState = new TorcDb2ClientConnectionState(properties);
  ...
  public static void executeQuery(Operation operation, 
      TorcDb2ClientConnectionState connState, ResultReporter resultReporter) 
      throws DbException {
    try {
  ...
  public static class LdbcQuery1Handler
    ...
    public void executeOperation(final LdbcQuery1 operation,
      ...
      TorcDb2Client.executeQuery(operation, 
          (TorcDb2ClientConnectionState) dbConnectionState, 
          resultReporter);
    }
  }
